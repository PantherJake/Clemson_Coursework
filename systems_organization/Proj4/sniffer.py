...
class PacketSniffer:
    ...
    def __sniff(self, pkt):
        ...
        try:
            ...
            print("An error occurred while unpacking this packet. This is not necessarily a problem, as errors are"
                  "expected for some packet types that we are not processing in this assignment.")
