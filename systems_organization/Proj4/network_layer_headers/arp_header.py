...
class ARPHeader(LayerHeader):
    def __init__(self, pkt):
        ...
        head = unpack("!HHBBH6sI6sI", self.header_bytes)

        self.hardware_type = head[0]
        self.protocol_type = head[1]
        self.hardware_address_len = head[2]
        self.protocol_address_len = head[3]
        self.opcode = head[4]
        self.sender_hardware_address = head[5]
        self.sender_protocol_address = head[6]
        self.target_hardware_address = head[7]
        self.target_protocol_address = head[8]
