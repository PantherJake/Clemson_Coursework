...
/*Read color ppm image for the header and store the ascii values in the vector */
ppm rColorPixel(ifstream& fp) {
...
/* Writing the ppm image to the file first with the header and looping to print the ascii values */
void wColorPixel(ofstream& fp, ppm a) {
fp << a.getMagicNum() << "\n" << a.getWidth() << " " << a.getHeight() << "\n" << a.getMax();
...
/*Reading binary numbers in and printing them to a file then calling the write function to write the file*/
void BinaryColor(ifstream& fp) {
int numPixels = 0;
int tempWidth = 0;
int tempHeight = 0;
